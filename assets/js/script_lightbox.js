...
function showImage(offset) {
    ...
    var currentThumbnail = thumbnailContainers[currentIndex].querySelector('.img-overlay');
...
document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape') {
        document.getElementById('custom-lightbox').style.display = 'none'; // Affichez la lightbox
    }
});